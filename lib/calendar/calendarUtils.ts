...
export function expandTimetableSlots(
  ...
  while (cursor <= end) {
    ...
    // Wednesday is match day, but can still carry real slots (e.g. a GCSE
    // session before travel/kick-off) — day_of_week 3 is a valid slot day,
    // same as any other; see 054_year1_timetable_2026_27.sql.
