...
export function GroupMembers({
  ...
  return (
    <div className="border-t bg-white p-3 space-y-2">
      ...
      {/* An auto-synced room hides the add/remove controls entirely, which
          read as "the app won't let me add learners" to staff. Say why, and
          point at the control that actually moves a learner in or out. */}
